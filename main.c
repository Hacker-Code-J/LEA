...
int main(int argc, char** argv) {
    ...
    // create_LEA128CBC_MCT_ReqFile(txtFileName, reqFileName);
    // create_LEA128CBC_MCT_FaxFile(txtFileName, faxFileName);
    // create_LEA128CBC_MCT_RspFile(reqFileName, rspFileName);
